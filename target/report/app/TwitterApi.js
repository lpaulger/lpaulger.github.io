...
if (! _$jscoverage['app/TwitterApi.js']) {
  ...
  _$jscoverage['app/TwitterApi.js'].lineData[11] = 0;
  _$jscoverage['app/TwitterApi.js'].lineData[17] = 0;
  _$jscoverage['app/TwitterApi.js'].lineData[19] = 0;
  _$jscoverage['app/TwitterApi.js'].lineData[21] = 0;
  _$jscoverage['app/TwitterApi.js'].lineData[33] = 0;
}
...
define(['jquery'], function($) {
  ...
  function TwitterApi(config) {
    ...
    var self = this;
    _$jscoverage['app/TwitterApi.js'].lineData[10]++;
    self.url = config.twitter.baseUrl;
    _$jscoverage['app/TwitterApi.js'].lineData[11]++;
    self.username = config.twitter.username;
    _$jscoverage['app/TwitterApi.js'].lineData[17]++;
    self.getRecentPosts = function(options) {
  _$jscoverage['app/TwitterApi.js'].lineData[19]++;
  var count = options.count;
  _$jscoverage['app/TwitterApi.js'].lineData[21]++;
  return $.ajax({
